...
public class ManageCategoryPage {
	...
	@FindBy(xpath = "//div[@class='row']//div[9]//a")WebElement managecategory_moreinfo;
	@FindBy(css = "a[onclick='click_button(1)']")WebElement newbutton;
	@FindBy(css = "input[placeholder='Enter the Category']")WebElement categorytextbox;
	@FindBy(id = "134-selectable")WebElement discountlocator;
